...
free(void *ap)
{
 ...
 765:	a1 08 0c 00 00       	mov    0xc08,%eax
...
free(void *ap)
{
 ...
 830:	a3 08 0c 00 00       	mov    %eax,0xc08
}
 835:	c9                   	leave  
 836:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 883:	e8 ce fe ff ff       	call   756 <free>
  return freep;
 888:	a1 08 0c 00 00       	mov    0xc08,%eax
}
 88d:	c9                   	leave  
 88e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8a1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8a4:	a1 08 0c 00 00       	mov    0xc08,%eax
 8a9:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8ac:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8b0:	75 23                	jne    8d5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8b2:	c7 45 f0 00 0c 00 00 	movl   $0xc00,-0x10(%ebp)
 8b9:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8bc:	a3 08 0c 00 00       	mov    %eax,0xc08
 8c1:	a1 08 0c 00 00       	mov    0xc08,%eax
 8c6:	a3 00 0c 00 00       	mov    %eax,0xc00
    base.s.size = 0;
 8cb:	c7 05 04 0c 00 00 00 	movl   $0x0,0xc04
 8d2:	00 00 00 
  }
 ...
 928:	a3 08 0c 00 00       	mov    %eax,0xc08
      return (void*)(p + 1);
 ...
 933:	eb 38                	jmp    96d <malloc+0xde>
    ...
    if(p == freep)
 935:	a1 08 0c 00 00       	mov    0xc08,%eax

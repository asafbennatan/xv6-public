...
printf(1,"before open \n");
   9:	c7 44 24 04 e2 08 00 	movl   $0x8e2,0x4(%esp)
  10:	00 
  11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  18:	e8 f6 04 00 00       	call   513 <printf>
  if(open("console", O_RDWR) < 0){
  1d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  24:	00 
  25:	c7 04 24 f0 08 00 00 	movl   $0x8f0,(%esp)
  2c:	e8 9a 03 00 00       	call   3cb <open>
  31:	85 c0                	test   %eax,%eax
  33:	79 30                	jns    65 <main+0x65>
   //  printf(1,"after open \n");
    mknod("console", 1, 1);
  35:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  3c:	00 
  3d:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
  44:	00 
  45:	c7 04 24 f0 08 00 00 	movl   $0x8f0,(%esp)
  4c:	e8 82 03 00 00       	call   3d3 <mknod>
   // printf(1,"after mknod \n");
    open("console", O_RDWR);
  51:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  58:	00 
  59:	c7 04 24 f0 08 00 00 	movl   $0x8f0,(%esp)
  60:	e8 66 03 00 00       	call   3cb <open>
   // printf(1,"after open 2\n");
  }
  dup(0);  // stdout
  65:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  6c:	e8 92 03 00 00       	call   403 <dup>
  dup(0);  // stderr
  71:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  78:	e8 86 03 00 00       	call   403 <dup>
  ...
  c8:	00 
  c9:	c7 04 24 df 08 00 00 	movl   $0x8df,(%esp)
 ...
 11e:	e9 5a ff ff ff       	jmp    7d <main+0x7d>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ac:	0f b6 80 90 0b 00 00 	movzbl 0xb90(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 609:	75 09                	jne    614 <printf+0x101>
          s = "(null)";
 60b:	c7 45 f4 3d 09 00 00 	movl   $0x93d,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d5:	a1 ac 0b 00 00       	mov    0xbac,%eax
...
free(void *ap)
{
 ...
 7a0:	a3 ac 0b 00 00       	mov    %eax,0xbac
}
 7a5:	c9                   	leave  
 7a6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7f3:	e8 ce fe ff ff       	call   6c6 <free>
  return freep;
 7f8:	a1 ac 0b 00 00       	mov    0xbac,%eax
}
 7fd:	c9                   	leave  
 7fe:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 811:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 814:	a1 ac 0b 00 00       	mov    0xbac,%eax
 819:	89 45 f0             	mov    %eax,-0x10(%ebp)
 81c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 820:	75 23                	jne    845 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 822:	c7 45 f0 a4 0b 00 00 	movl   $0xba4,-0x10(%ebp)
 829:	8b 45 f0             	mov    -0x10(%ebp),%eax
 82c:	a3 ac 0b 00 00       	mov    %eax,0xbac
 831:	a1 ac 0b 00 00       	mov    0xbac,%eax
 836:	a3 a4 0b 00 00       	mov    %eax,0xba4
    base.s.size = 0;
 ...
 898:	a3 ac 0b 00 00       	mov    %eax,0xbac
      return (void*)(p + 1);
 ...
 8a3:	eb 38                	jmp    8dd <malloc+0xde>
    ...
    if(p == freep)
 8a5:	a1 ac 0b 00 00       	mov    0xbac,%eax
